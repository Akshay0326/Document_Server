...
// edit
                   // final comment on 6-07-2022
Route::get('showproduct',[TaskController::class,'showproduct']);

Route::get('edit/{id}',[TaskController::class,'showData'])->name('showData');
Route::any('/edit',[TaskController::class,'update']);
// ->name('update');
...
// Route::get('/edit/{id}', 'TaskController@showData')->name('showData');
// Route::patch('/edit','TaskController@update')->name('update');
